...
public class DailyPracticeApril24 {
    // binarySearch
    ...
    // prefix
    public static int[] prefix(int[]numbers){
    ...
    // suffix
    public static int[] suffix(int[] numbers) {
    ...
    public static int findSubArrays(int[] array, int k) {
        ...
        for (int num : array) {
            // do logic
            answer += map.getOrDefault(current - k, 0);
    ...
    public static int monotonicIncreasingStack(int[] array) {
        ...
        for (int num : array) {
            // Example: from bottom to top 1246. so if num is 3 pop twice then push 3
    ...
    public static boolean binaryTreeDsfRec(TreeNode root, int key) {
        if (root == null) {
            return false;
        }
        ...
        return binaryTreeDsfRec(root.left, key) || binaryTreeDsfRec(root.right, key);
    }

    // binaryTreeDfs(iterative)
    public static boolean binaryTreeDsfIterative(TreeNode root, int key) {
    ...
    // binaryTreeBfs
    public static boolean binaryTreeBsf(TreeNode root, int key) {
