...
public class DailyPracticeApril28 {
    // binarySearch
    ...
    // twoPointerOneInput
    public static boolean twoPointer1Input(int[] array, int key) {
        int left = 0;
        int right = array.length - 1;
    ...
    // twoPointerTwoInput
    public static int[] twoPointer2Input(int[] array1, int[] array2) {
    ...
    public static int[] slidingWindow(int[] array, int windowSize) {
        ...
        for (int i = windowSize; i < array.length; i++) {
            list.add(sum - array[left] + array[i]);
        }
